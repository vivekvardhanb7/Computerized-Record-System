    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="sub-2.php">
              <i class="bi bi-circle"></i><span>Software Engineering</span>
            </a>
          </li>
          <li>
            <a href="sub-3.php">
              <i class="bi bi-circle"></i><span>Computer Networks</span>
            </a>
          </li>
        </ul>
      </li><!-- End Editors Nav -->
    ...
    <section class="section dashboard">
      <div class="row">
                ...
                <div class="d-flex align-items-center">
                    <div class="ps-3">
                      <h6>Computer Networks</h6>
                        <span class="small pt-2 fw-bold">CS3102</span>
                    </div>
                  </div>
            </div>
          </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">TinyMCE Text Editor</h5>
              <!-- TinyMCE Editor -->
              ...
              <br>
              <input type="button" class="btn btn-primary btn-lg" value="Submit" onclick="submit()">
            </div>
          </div>
