                  ...
                  <table class="table table-borderless datatable ">
                    ...
                    <tbody>
                      <?php
                        require'config.php';
                        $mail=$_SESSION['Email'];
                        $sql ="select * from recorddetails where mail='$mail'";
                        $query=mysqli_query($con,$sql) or die(mysqli_error());
                      ...
                      <tr>
                        ...
                        <td><a href='getrecord_data.php?id="<?php echo $fetch['mail'];?>"' class="text-primary">OS Record</a></td>
                        <td><?php echo $fetch['date']?></td>
                        <td><a href='delete-record.php?id="<?php echo $fetch['subjectcode'];?>"' class="link-danger">Delete</a></td>
                      </tr>
                      <!-- <tr>
